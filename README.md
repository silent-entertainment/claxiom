...
And now we present the claxiom notebook,  with which you can record your stream of thoughts and code as they flow, test those thoughts and keep a running record of your progress, in a format that is easier on the eyes than plain text with ugly syntax, which might make it handy for sharing your thoughts.
